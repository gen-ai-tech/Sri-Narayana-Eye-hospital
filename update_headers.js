...
['about.html', 'services.html', 'contact.html', 'portal.html'].forEach(file => {
  ...
  content = content.replace(/href="css\/components\.css(\?v=\d+)?"/g, 'href="css/components.css?v=22"');
  content = content.replace(/href="css\/styles\.css(\?v=\d+)?"/g, 'href="css/styles.css?v=22"');
